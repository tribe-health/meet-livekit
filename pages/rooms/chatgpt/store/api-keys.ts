...
const initialState: {
    ...
    openAIApiKey: typeof window !== 'undefined' ? localStorage.getItem('openai-api-key') : null,
    useOpenAIWhisper: false,
    elevenLabsApiKey: typeof window !== 'undefined' ? localStorage.getItem('elevenlabs-api-key') : null,
};
